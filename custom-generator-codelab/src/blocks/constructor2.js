Blockly.Blocks['custom_procedures_defnoreturn'] = {
  ...
  init: function () {
    ...
    this.setMutator(new Blockly.Mutator(['constructor_mutatorarg']));
  ...
  decompose: function (workspace) {
     ...
     * <block type="custom_procedures_mutatorcontainer">
     *   <statement name="STACK">
     *     <block type="constructor_mutatorarg">
    ...
    containerBlockNode.setAttribute('type', 'custom_procedures_mutatorcontainer');
    ...
    for (var i = 0; i < this.arguments_.length; i++) {
      ...
      argBlockNode.setAttribute('type', 'constructor_mutatorarg');
    ...
    if (this.type == 'custom_procedures_defreturn') {
  ...
  displayRenamedVar_: function (oldName, newName) {
    ...
    if (this.mutator && this.mutator.isVisible()) {
      ...
      for (var i = 0, block; (block = blocks[i]); i++) {
        if (block.type == 'constructor_mutatorarg' &&
  ...
  callType_: 'custom_procedures_callnoreturn'
};
...
Blockly.Blocks['custom_procedures_defreturn'] = {
  ...
  setStatements_: Blockly.Blocks['custom_procedures_defnoreturn'].setStatements_,
  updateParams_: Blockly.Blocks['custom_procedures_defnoreturn'].updateParams_,
  mutationToDom: Blockly.Blocks['custom_procedures_defnoreturn'].mutationToDom,
  domToMutation: Blockly.Blocks['custom_procedures_defnoreturn'].domToMutation,
  decompose: Blockly.Blocks['custom_procedures_defnoreturn'].decompose,
  compose: Blockly.Blocks['custom_procedures_defnoreturn'].compose,
  /**
   * Return the signature of this procedure definition.
   * @return {!Array} Tuple containing three elements:
   *     - the name of the defined procedure,
  ...
  getVars: Blockly.Blocks['custom_procedures_defnoreturn'].getVars,
  getVarModels: Blockly.Blocks['custom_procedures_defnoreturn'].getVarModels,
  renameVarById: Blockly.Blocks['custom_procedures_defnoreturn'].renameVarById,
  updateVarName: Blockly.Blocks['custom_procedures_defnoreturn'].updateVarName,
  displayRenamedVar_: Blockly.Blocks['custom_procedures_defnoreturn'].displayRenamedVar_,
  customContextMenu: Blockly.Blocks['custom_procedures_defnoreturn'].customContextMenu,
  callType_: 'custom_procedures_callreturn'
};
...
Blockly.Blocks['constructor_mutatorarg'] = {
  /**
...
Blockly.Blocks['custom_procedures_callnoreturn'] = {
  ...
  onchange: function (event) {
    ...
    if (event.type == Blockly.Events.BLOCK_CREATE &&
      ...
      if (!def) {
         ...
         *   <block type="custom_procedures_defreturn" x="10" y="20">
         *     <mutation name="test">
         *       <arg name="x"></arg>
         *     </mutation>
  ...
  defType_: 'custom_procedures_defnoreturn'
};
...
Blockly.Blocks['custom_procedures_callreturn'] = {
  ...
  getProcedureCall: Blockly.Blocks['custom_procedures_callnoreturn'].getProcedureCall,
  renameProcedure: Blockly.Blocks['custom_procedures_callnoreturn'].renameProcedure,
  setProcedureParameters_:
    Blockly.Blocks['custom_procedures_callnoreturn'].setProcedureParameters_,
  updateShape_: Blockly.Blocks['custom_procedures_callnoreturn'].updateShape_,
  mutationToDom: Blockly.Blocks['custom_procedures_callnoreturn'].mutationToDom,
  domToMutation: Blockly.Blocks['custom_procedures_callnoreturn'].domToMutation,
  getVars: Blockly.Blocks['custom_procedures_callnoreturn'].getVars,
  getVarModels: Blockly.Blocks['custom_procedures_callnoreturn'].getVarModels,
  onchange: Blockly.Blocks['custom_procedures_callnoreturn'].onchange,
  customContextMenu:
    Blockly.Blocks['custom_procedures_callnoreturn'].customContextMenu,
  defType_: 'custom_procedures_defreturn'
};
...
Blockly.Blocks['procedures_ifreturn'] = {
  ...
  onchange: function (_e) {
    ...
    if (legal) {
      ...
      if (block.type == 'custom_procedures_defnoreturn' && this.hasReturnValue_) {
        this.removeInput('VALUE');
        this.appendDummyInput('VALUE')
          .appendField(Blockly.Msg['PROCEDURES_DEFRETURN_RETURN']);
        this.hasReturnValue_ = false;
      } else if (block.type == 'custom_procedures_defreturn' &&
   ...
   */
  FUNCTION_TYPES: ['custom_procedures_defnoreturn', 'custom_procedures_defreturn']
};
